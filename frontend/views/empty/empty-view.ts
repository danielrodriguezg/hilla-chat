...
export class EmptyView extends View {
  ...
  render() {
    return html`
    <h3>Chat - Ejercicio sencillo WebFlux con Hilla, Lit y SpringBoot</h3>
    <vaadin-message-list class="flex-grow" .items=${this.messages}>
    </vaadin-message-list>
    <div class="flex p-s gap-s items-baseline">
      <vaadin-text-field placeholder="Nombre" @change=${this.userNameChange}></vaadin-text-field>
